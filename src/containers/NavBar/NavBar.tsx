...
const NavBar: React.FC = () => {
  ...
  return (
    <div className="nav-bar">
      <div className="logo">
        <h4 className="slogon">Loaders</h4>
        <h4 className="slogon">Loaders</h4>
      </div>
      <div className="links">
        ...
        <a
          className="github"
          href="https://github.com/AM-77/loaders"
      ...
      <div className="nbr-visitors">
        <img
          src="http://visitor-badge.glitch.me/badge?page_id=pure-css-loders.visitor-badge"
          alt="cool"
        />
      </div>
    </div>
